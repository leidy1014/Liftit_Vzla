...
const resenas_controller_1 = require("./resenas.controller");
let ResenasModule = class ResenasModule {
};
exports.ResenasModule = ResenasModule;
exports.ResenasModule = ResenasModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([resena_entity_1.Resena])],
        controllers: [resenas_controller_1.ResenasController],
        providers: [resenas_service_1.ResenasService],
    })
], ResenasModule);
